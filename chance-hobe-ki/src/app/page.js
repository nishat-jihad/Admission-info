        ...
        <div className="hero-inner">
          <div className="hero-text">
            ...
            <div className="hero-cta">
              ...
              <Link href="/general-check" className="btn3d btn3d-ssc" style={{ textDecoration: "none" }}>
                <span className="button_top">SSC+HSC দিয়ে ভার্সিটির যোগ্যতা চেক করো </span>
              </Link>
              <Link href="/exam-dates" className="btn3d btn3d-exam" style={{ textDecoration: "none" }}>
                <span className="button_top"> একত্রে ভর্তি পরীক্ষার তারিখসমূহ
                </span>
              </Link>
            </div>
          </div>
